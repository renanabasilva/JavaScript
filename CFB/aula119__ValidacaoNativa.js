...
document.querySelector('#btn_validar').addEventListener('click', (evt) => {
  ...
  if(estadoValidacao.valueMissing){
    f_nota.setCustomValidity('Este campo é obrigatório. Você deve preenche-lo')
...
//     msg = 'Este campo é obrigatório. Você deve preenche-lo'
...
rangeUnderflow: true, se o valor de um elemento for inválido por seu atributo min.
